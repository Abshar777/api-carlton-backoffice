"""
MongoDB Backup Script — Carlton AC
...
BOT_TOKEN = os.environ.get("TELEGRAM_BOT_TOKEN", "8580624177:AAFAUTK6BCcd2OgQGwniuqzXbId0FtcXXMw")
CHAT_ID = os.environ.get("TELEGRAM_BACKUP_CHAT_ID", "-1003874788154")
...
async def run_backup():
    ...
    await send_message_to_telegram(f"🔁 *Carlton AC Backup started*\nDB: `{DB_NAME}`\nTime: `{timestamp} UTC`")
    ...
    # Summary message
    summary = (
        f"✅ *Carlton AC Backup complete* — `{DB_NAME}`\n"
